...
val rainbow = Color("rainbow")

case class Card(typ: String, color: Color, value: Int) {
  override def toString: String = {
    s"$color $value"
  }
...
val r1 = Card("regular", red, 1)

val r2 = Card("regular", red, 2)

val r3 = Card("regular", red, 3)

val cards = List[Card](r1, r2, r3)


case class Hand(cards: List[Card], value: Int) {
  override def toString: String = {
    cards.mkString(", ")
  }
}

val hand_player1 = Hand(cards, 3)
